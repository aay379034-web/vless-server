...
<head>
    ...
    <style>
        ...
        .platform-logo { width: 90px; height: 90px; border-radius: 50%; border: 2px solid #00ffc4; object-fit: cover; display: block; margin: 0 auto 12px auto; box-shadow: 0 0 20px rgba(0, 255, 196, 0.3); background: rgba(0, 255, 196, 0.1); }
...
<body>
    <div class="container">
        <img src="https://i.ibb.co/hL76735/1000169131-2.png" onerror="this.style.display='none'" class="platform-logo" alt="شعار">
